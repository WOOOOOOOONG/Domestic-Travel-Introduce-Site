...
<span>
  ...
  <b>회원가입</b><br><br>
  ㆍ 회원 가입을 위한 정보에 대한 처리<br>
  ㆍ 아이디 중복확인 기능<br>
  ㆍ 비밀번호를 비롯한 모든 내용에 정규화<br>
  ㆍ 이메일 인증<br>
...
<div>
  ...
  <b>MyPage</b><br><br>
   -좌측<br>
  ㆍ 회원별 프로필 사진과 별명을 화면에 보여주고, 클릭을 통한 프로필 사진 교체 기능  <br>
  ㆍ 로그아웃/회원정보 수정/내가 쓴 게시글 확인 등 홈페이지 내 사용자의 활동 내역 확인  <br><br>
  -중앙<br>
  ㆍ Google의 FullCalendar를 사용<br>
...
<div>
  ...
  ㆍ 홈페이지에서 제공하는 여행지 및 축제 보여주기 기능<br>
...
<div>
  ...
  ㆍ 여행에 필요한 정보를 입력받아 DB에 추가 기능<br>
